...
var usdmColors = {"0":"#1f78b4", "1":"#99cf95", "2":"#f8a64f", "3":"#229a00",
    "4":"#FB9A99" };

var usdmData = L.geoJson(null, {
  style: function (feature) {
    return {
      color: usdmColors[feature.properties.dm],
      weight: 0,
      opacity: 0.6
    };
  }
...
slider.noUiSlider.on('set', function(){
  getData();
  callDrought(tuesdayReport);
});

//map.addLayer(usdmData);

$.getJSON ("https://cisa.cartodb.com/api/v2/sql/?format=GeoJSON&q=SELECT * FROM marchjson WHERE date ='"+tReport+"'", function (data) {
  usdmData.addData(data);
});
/////////////////////////////////////////////////////////////OLD
// function getData(){
...
///////////////USDM Layer////////////////////////////
//$.getJSON("https://cisa.cartodb.com/api/v2/sql/?format=GeoJSON&q=SELECT * FROM marchjson WHERE date =" tuesdayReport, function (data) {
      




// function callDrought(tuesdayReport) {
//   console.log("callDrought dmDate: "+tuesdayReport);
//     map.removeLayer(usdmData);

//     usdmData = L.tileLayer.wms( "http://torka.unl.edu:8080/cgi-bin/mapserv.exe",{
//       map: "/ms4w/apps/dm/service/usdm"+dmDate+"_wms.map",
//       layers: "usdm"+dmDate,
//       styles: "default",
//       format: "image/png",
